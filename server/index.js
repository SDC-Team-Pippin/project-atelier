...
app.post('/qa/questions', (req, res) => {
  ...
  const queryParams = [productId, body, name, email];
  client
    .query(query, queryParams)
    .then(() => (
...
app.post('/qa/answers', (req, res) => {
  ...
  const query = 'INSERT INTO answers(question_id, body, answerer_name, answerer_email) VALUES ($1, $2, $3, $4);';
